...
![Desktop preview](https://github.com/namanbansal02/readme-storage/blob/main/instagram-videos-downloader/desktop-preview.gif?raw=true)

Responsive on mobile and small devices.

![Mobile preview](https://github.com/namanbansal02/readme-storage/blob/main/instagram-videos-downloader/mobile-preview.gif?raw=true)
...
```bash
git clone https://github.com/namanbansal02/Insta-downloader.git
```
...
![API response preview](https://github.com/namanbansal02/readme-storage/blob/main/instagram-videos-downloader/api-response-preview.png?raw=true)
