...
export default function HomePage() {
  return (
    <main id="main" className="flex w-full flex-1 flex-col font-sans">
      <section
        id="#download"
        className={cn(
          "flex w-full flex-col items-center px-4 py-24 shadow-sm",
          "bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-40% to-emerald-500 to-90% "
        )}
      >
        <h1
          className={cn(
            "py-2 text-center text-2xl font-bold text-white sm:text-4xl"
          )}
        >
        ...
        <section id="logo">
          <div className="flex w-full items-center justify-center gap-4">
            ...
            <div
              aria-label="Logo"
              className={cn(
                "flex select-none flex-col items-start text-2xl font-bold md:text-5xl",
